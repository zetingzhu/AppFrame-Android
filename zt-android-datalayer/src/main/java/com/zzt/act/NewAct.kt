...
class NewAct : AppCompatActivity() {
    val TAG = NewAct::class.java.simpleName

    companion object {
        @JvmStatic
        fun start(context: Context) {
            val starter = Intent(context, NewAct::class.java)
...
//        getDataCount()
    ...
    fun getDataCount() {
        ...
        if (dataCount != null) {
            ...
            var logStr = "原来进程名字：" + SystemUtil.getProcessName(this) + "\n 数据:" + dataCount
